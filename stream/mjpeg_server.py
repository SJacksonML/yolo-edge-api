...
def main():
    ...
    print(f"[INFO] Acesse no navegador: http://100.107.210.16:{args.port}/")
    print(f"[INFO] Stream direto:        http://100.107.210.16:{args.port}/stream")
    print(f"[INFO] Health check:         http://100.107.210.16:{args.port}/health")
